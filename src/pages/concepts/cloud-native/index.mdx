...
The Cloud Native Computing Foundation (CNCF) seeks to drive adoption of
this paradigm by fostering and sustaining an ecosystem of open source,
...
components. They have their own resources. Each component must
be owned by a self-sufficient, full stack team. That team is entirely
responsible for all the resources that belong to that particular
component. In this set up, a team tends to build quality in up front as
...
thinking at a high level, we have to first prove that the low level
...
business, you can quickly and safely deliver scalable applications.
...
-   Without Containerization, you cannot build cloud native
...
-   Monitoring and Observability play very important roles. Establish
    standard logging practices and standard events to get the widest
    coverage and clearest visibility.
